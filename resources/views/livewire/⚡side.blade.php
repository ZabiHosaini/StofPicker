...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content">
      <!-- Navbar -->
      <nav class="navbar min-h-10 h-15 bg-gray-700 text-white px-2">
    ...
    <div class="drawer-side is-drawer-close:overflow-visible">
      ...
      <div class="flex min-h-full flex-col items-start bg-gray-800 text-white is-drawer-close:w-14 is-drawer-open:w-64">
